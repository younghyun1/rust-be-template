...
CREATE TABLE public.user_profile_pictures (
    ...
    user_profile_pictures_user_profile_pictures_created_at timestamptz DEFAULT now () NOT NULL,
    user_profile_pictures_user_profile_pictures_updated_at timestamptz DEFAULT now () NOT NULL,
